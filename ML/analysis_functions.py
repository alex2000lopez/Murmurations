...
def process_segments(
    ...
    for segs in segments.values():
        ...
        for start_samp, end_samp in segs:
            seg_audio_len = end_samp - start_samp
            if seg_audio_len > max_audio_len:
                max_audio_len = seg_audio_len

            seg_adc_len = (end_samp // 12) - (start_samp // 12)
            if seg_adc_len > max_adc_len:
                max_adc_len = seg_adc_len
    # ------------------------------------------------------------------
    # Prepare memmap
    # ------------------------------------------------------------------
